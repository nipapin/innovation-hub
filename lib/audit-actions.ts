...
export const AUDIT_ACTIONS = [
  ...
  // Заведение сотрудника изнутри компании (план §7). Отдельно от
  // `company.member_transferred`: там человек уже был у нас и сменил
  // принадлежность, здесь аккаунта не существовало вовсе. Разное действие и
  // разный вес — перевод задевает деньги, заведение нет.
