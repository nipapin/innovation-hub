...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    /**
     * Рисовать ли крестик в углу. По умолчанию да — так ведут себя все прежние
     * диалоги, и менять это молча нельзя.
     *
     * `false` — для окон, где крестик лишний: щелчок вне окна и `Esc` закрывают
     * его и так, а в плотной шапке крестик отнимает место у того, ради чего
     * окно открыли. Закрытие при этом никуда не девается — оно просто не
     * занимает отдельной кнопки.
     */
    showClose?: boolean
  }
